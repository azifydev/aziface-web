export const el = {
  ...
  FaceTec_retry_official_id_photo_subheader_message:
    'Χρειαζόμαστε καλύτερη ποιότητα',
  FaceTec_retry_official_id_photo_instruction_message:
    'Δοκίμασε σε εσωτερικό χώρο,<br/>Χωρίς έντονο φως, χαμόγελο και καπέλο',
  ...
  FaceTec_result_facescan_success_3d_enrollment_message:
    'Το πρόσωπο σαρώθηκε<br/>Αποδεδειγμένη ζωντάνια 3D',
  FaceTec_result_facescan_success_3d_3d_reverification_message:
    'Αποδεδειγμένη ζωντάνια 3D<br/>Το πρόσωπο επαληθεύτηκε',
  ...
  FaceTec_result_facescan_upload_message_still_uploading:
    'Ακόμα Ανεβαίνει...<br/>Αργή Σύνδεση',
  ...
  FaceTec_result_idscan_upload_message_back_side_upload_complete_awaiting_processing:
    'Επεξεργασία<br/>Πίσω Μέρους Ταυτότητας',
  FaceTec_result_idscan_upload_message_user_confirmed_info_upload_started:
    'Σώζονται<br/>Οι Επιβεβαιωμένες σας Πληροφορίες',
  ...
  FaceTec_result_idscan_success_front_side_message:
    'Η Φωτογραφία της Ταυτότητας <br/>Σαρώθηκε',
  ...
  FaceTec_result_idscan_success_passport_message:
    'Η σάρωση διαβατηρίου ολοκληρώθηκε',
  FaceTec_result_idscan_success_user_confirmation_message:
    'Η Σάρωση της Ταυτότητας <br/>Ολοκληρώθηκε',
  ...
  FaceTec_result_idscan_retry_id_type_not_suppported_message:
    'Η ταυτότητα δεν υποστηρίζεται<br/>Χρησιμοποιήστε διαφορετική ταυτότητα',
  ...
  FaceTec_result_idscan_additional_review_tag_message:
    'Απαιτείται Μη Αυτόματος έλεγχος<br/> Παρακαλούμε Δείτε τον Πίνακα Ελέγχου IDV',
} as const
