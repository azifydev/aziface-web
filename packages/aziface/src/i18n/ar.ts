export const ar = {
  ...
  FaceTec_retry_official_id_photo_subheader_message:
    'نحتاج إلى صورة عالية الجودة.',
  FaceTec_retry_official_id_photo_instruction_message:
    'يُرجى استخدام إضاءة داخلية،<br/>دون نظارة شمسية أو ابتسام أو غطاء رأس.',
  ...
  FaceTec_result_facescan_success_3d_enrollment_message:
    'تم مسح الوجه ضوئيًا<br/>تم إثبات حيوية ثلاثية الأبعاد',
  FaceTec_result_facescan_success_3d_3d_reverification_message:
    'تم إثبات حيوية ثلاثية الأبعاد<br/>تم التحقق من الوجه',
  ...
  FaceTec_result_facescan_upload_message_still_uploading:
    'لا تزال عملية التحميل جارية...<br/> الاتصال بطيء',
  ...
  FaceTec_result_idscan_retry_id_type_not_suppported_message:
    'بطاقة الهوية غير مدعومة<br/>‏يرجى استخدام بطاقة هوية مختلفة',
  ...
  FaceTec_result_idscan_additional_review_tag_message:
    'المراجعة اليدوية مطلوبة<br/>‏يُرجى الاطلاع على لوحة معلومات IDV',
} as const;
