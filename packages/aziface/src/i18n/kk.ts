export const kk = {
  ...
  FaceTec_retry_official_id_photo_subheader_message:
    'Сапасы жоғары сурет керек',
  FaceTec_retry_official_id_photo_instruction_message:
    'Ішкі жарықты қолданыңыз,<br/>Көзілдірікте жарқылсыз, күлмеңіз, бас киімсіз',
  ...
  FaceTec_idscan_review_id_front_instruction_message:
    'Таза Фотосуретті Растаңыз',
  FaceTec_idscan_review_id_back_instruction_message:
    'Түсінікті Фотосуретті Растаңыз',
  ...
  FaceTec_result_facescan_success_3d_enrollment_message:
    'Бетті сканерлеу<br/>расталған 3D-өміршеңдік',
  FaceTec_result_facescan_success_3d_3d_reverification_message:
    '3D өміршеңдігі расталды<br/>бет тексерілді',
  ...
  FaceTec_result_facescan_upload_message_still_uploading:
    'Әлі Жүктеп Жатыр...<br/>Баяу Байланыс',
  ...
  FaceTec_result_idscan_upload_message_back_side_upload_complete_awaiting_processing:
    'ӨҢДЕУ<br/>ИДЕНТИФИКАТОРДЫҢ Артқы Жағы',
  FaceTec_result_idscan_upload_message_user_confirmed_info_upload_started:
    'Сіздің Расталған Ақпаратыңызды Сақтау',
  ...
  FaceTec_result_idscan_success_front_side_message:
    'Фотосурет ИДЕНТИФИКАТОРЫ<br/>Сканерленген',
  ...
  FaceTec_result_idscan_success_user_confirmation_message:
    'ЖЕКЕ КУӘЛІКТІ Сканерлеу<br/>Аяқталды',
  ...
  FaceTec_result_idscan_retry_id_type_not_suppported_message:
    'ИДЕНТИФИКАТОРҒА Қолдау көрсетілмейді<br/>Басқа ИДЕНТИФИКАТОРДЫ Пайдаланыңыз',
  ...
  FaceTec_result_idscan_additional_review_tag_message:
    'Қолмен Тексеру Қажет<br/>IDV Бақылау Тақтасын Қараңыз',
} as const;
