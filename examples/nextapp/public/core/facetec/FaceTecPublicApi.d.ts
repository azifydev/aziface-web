...
export declare enum FaceTecInitializationError {
  ...
  RejectedByServer = 0,
  /**
   * The provided FaceTecProcessor called abortOnCatastrophicError() and the application could not be validated.
   */
  RequestAborted = 1,
  /**
 ...
 */
export interface FaceTecProcessorCallback {
  /**
 ...
 * by the FaceTec SDK
 */
export interface FaceTecProcessor {
  /**
   ...
   */
  onSessionRequest(requestBlob: string, requestCallback: FaceTecProcessorCallback): void;
...
export interface FaceTecSDKInstance {
   ...
   * @param Processor A custom object for processing SDK requests.
   */
