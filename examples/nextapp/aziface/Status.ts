...
import type { FaceTecInitializationError, FaceTecSessionStatus } from '../public/core/facetec/FaceTecPublicApi';
  ...
  public static descriptionForInitializationError(enumValue: FaceTecInitializationError): string {
    switch (enumValue) {
      ...
      case FaceTecSDK.FaceTecInitializationError.RequestAborted:
        return 'The provided FaceTecProcessor called abortOnCatastrophicError() and the application could not be validated.';
